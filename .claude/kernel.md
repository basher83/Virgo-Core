...
| **Quantum** | 3 (Holly, Lloyd, Mable) | Management plane (Omni, controllers) | Local LVM-thin + NFS | 192.168.10.0/24 |
...
| Network Overlay | Tailscale | OIDC via tsidp, HTTPS certs |
...
- Management plane (Omni, controllers) runs on Quantum, workloads on Matrix
...
|------------|--------|---------------|
| Omni Deployment | In Progress | `specs/omni.yaml` |
